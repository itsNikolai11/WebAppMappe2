    ...
    public class DBInit
    {
        public static void InitDB(IApplicationBuilder app)
        {
            using (var serviceScope = app.ApplicationServices.CreateScope())
            {
                ...
                var avgang1 = new Avganger { RuteNr = rute1, AvgangTid = "01/09/2023 12:12:00" };//new DateTime(2021, 10, 10, 19, 00, 00) };
                var avgang2 = new Avganger { RuteNr = rute2, AvgangTid = "01/09/2023 12:12:00" };//new DateTime(2021, 11, 10, 18, 30, 00) };
                var avgang3 = new Avganger { RuteNr = rute2, AvgangTid = "01/09/2023 12:12:00" };//new DateTime(2021, 11, 12, 18, 30, 00) }; 
